...
$lang_con_env_pdf=" Etes-vous sûr de vouloir envoyer par courriel le bon N°";
$lang_con_env_notif=" Etes-vous sûr de vouloir notifier par courriel le client du bon N°";
...
$lang_lot_act= "Etes-vous sûr de vouloir réactiver le lot N°";
...
$lang_benef = "Bénéfice";
$lang_factux = "FactuX.5 - Le Facturier libre Révision 2015";
...
$lang_source_fac = "$lang_factux est un logiciel à source ouverte &laquo;open source&raquo;<br>Dérivé de <a href='http://factux.sourceforge.net/wiki/' target='_blank' >Factux 1.1.5</a> ét maintenu par";
...
$lang_back_upl = "Si vous désirez restaurer cette sauvegarde :<br>1.Téléverser le fichier dans le répertoire dump de votre $lang_factux.<br>2.Executer l'utilitaire de Sauvegarde et choissiser l'option restaurer une sauvegarde";
...
$lang_back_resto = "La restauration de cette sauvegarde c'est déroulé avec succés";
...
$lang_devis_numero = "$lang_devis N°";
$lang_num_dev ="$lang_numero de $lang_devis";
...
$lang_suite_edit_utilisateur_succes = "Les nouvelles données de l'utilisateur $login2 ont bien été enregistrées";
...
$lang_login_existe = "Erreur le login existe deja";
...
#var_dump($GLOBALS); //4 AUTOTRANSLATE
?>
