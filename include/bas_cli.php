 ...
 */
?>
  <table class="rien" cellspacing="0" cellpadding="0" align="center">
   <tr>
    <td class="rien"><?php echo $lang_factux ?>
    <td class="rien" rowspan="2"><a href="http://factux.free.fr" target="_blank" ><img src="../image/factux.gif" height="77" alt="<?php echo $lang_factux ?>" ></a></td>
   <tr>
   <td class="rien"> 
