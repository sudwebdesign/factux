...
foreach($liste_mois as $numero_mois => $nom_mois){
 $recettes [$numero_mois] =  ["htva" => 0.0, "tva" => 0.0, "T.T.C" => 0.0];
 $depenses [$numero_mois] =  ["htva" => 0.0, "tva" => 0.0, "T.T.C" => 0.0];
...
<table class='page boiteaction'>
 <caption><?php
echo sprintf('%s %s', $lang_statistiques_annee, $annee_1);
?></caption>
 <tr>
  <th><?php
echo $lang_mois;
?></th>
  <th><?php
echo $lang_depenses_htva;
?></th>
  <th><?php
echo $lang_ca_htva;
?></th>
  <th><?php
echo $lang_resultat_net;
?></th>
  <th><?php
echo $lang_ca_ttc;
?></th>
  <th rowspan="14" width="200px"><img src="graph2_ca_ttc.php?annee_1=<?php
echo $annee_1;
?>"></th>
 </tr>
<?php
...
?>
 <tr>
  <td class='totaltexte'><?php
echo $lang_annee;
?></td>
  <td class='totalmontant'><?php
echo montant_financier ($de);
?></td>
  <td class='totalmontant'><?php
echo montant_financier ($ca);
?></td>
  <td class='totalmontant'><?php
echo montant_financier ($re);
?></td>
  <td class='totalmontant'><?php
echo montant_financier ($cat);
?></td>
 </tr>
</table>
<br>
<?php
include(__DIR__ . "/graph_ca.php");
echo "<br>";
include(__DIR__ . "/graph_dep.php");
echo "<br>";
include(__DIR__ . "/graph_ben.php");
?>
  </td>
 </tr> <!---->
 <tr>
  <th>
   <center>
    <div style="display:inline-block;width:33%;"><?php
echo ucfirst($lang_commandé);
?><br /><img src="graph2_ca.php?annee_1=<?php
echo $annee_1;
?>"></div>
    <div style="display:inline-block;width:33%;"><?php
echo ucfirst($lang_facturé);
?><br /><img src="graph2_ca_fact.php?annee_1=<?php
echo $annee_1;
?>"></div>
    <div style="display:inline-block;width:33%;"><?php
echo ucfirst($lang_acquitté);
?><br /><img src="graph2_ca_payes.php?annee_1=<?php
echo $annee_1;
?>"></div>
   </center>
<?php
#include("graph_circulaire_annuel.php");
?>
  </th>
 </tr> <!---->
 <tr>
