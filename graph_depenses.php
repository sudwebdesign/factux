...
?>
   <table class='page boiteaction'>
    <caption><?php
echo sprintf('%s %s %s', $lang_depenses_tri_par_fournisseur, $mois_1, $annee_1);
?></caption>
    <tr>
     <th><?php
echo $lang_fournisseur;
?></th>
     <th><?php
echo $lang_total_htva;
?></th>
     <th><?php
echo $lang_tot_tva;
?></th>
...
?></td>
     <td class="totalmontant"><?php
echo montant_financier ($total_gene);
?></td>
     <td class="totalmontant"><?php
echo montant_financier ($ttva);
?></td>
     <td class="totalmontant"><?php
echo montant_financier ($tttc);
?></td>
    </tr>
   </table>
  </td>
