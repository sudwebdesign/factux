...
if(isset($sqldbc)){
 ...
 mysql_query($sql) || die('Erreur SQL !'.$sql.''.mysql_error());
 echo sprintf('Votre base de donnée %s à été crée avec succes<hr>', $db);
}
...
';
$monfichier = fopen(__DIR__ . "/../include/config/common.php", "a+");
...
. " article varchar(40) NOT NULL default '0',
 ...
 PRIMARY KEY ( `num` ) )  ";
mysql_query($sql) || die('Erreur SQL1 !'.$sql.''.mysql_error());
...
. " client_num int( 10 ) NOT NULL default '0',
 ...
 PRIMARY KEY ( `num_bon` ) )  ";
mysql_query($sql2) || die('Erreur SQL2 !'.$sql2.''.mysql_error());//2
...
mysql_query($sql3) || die ('erreur sql3 !'.$sql3.''.mysql_error());//3

$sql_cat='CREATE TABLE '.$tblpref.'categorie (`id_cat` int(11) NOT NULL auto_increment,'
." `categorie` varchar(30) NOT NULL default '',
 PRIMARY KEY  (`id_cat`) )  ";
mysql_query($sql_cat) || die ('erreur sql !'.$sql_cat.''.mysql_error());//sql_cat
...
. " bon_num int(30) NOT NULL default '0',
 ...
 PRIMARY KEY ( num ) )  ";
mysql_query($sql4) || die ('erreur sql4 ! '.$sql4.''.mysql_error());//4
...
. " date date NOT NULL default '0000-00-00',
 ...
 PRIMARY KEY ( num ) )  ";
mysql_query($sql5) || die ('erreur sql5 ! '.$sql5.''.mysql_error());//5
...
. " date_deb date NOT NULL default '0000-00-00',
 ...
 PRIMARY KEY ( num ) )  ";
mysql_query($sql6) || die ('erreur sql6 ! ! '.$sql6.''.mysql_error());//6
...
. " login varchar( 10 ) NOT NULL default '',
 ...
 PRIMARY KEY ( num ) )  ";
mysql_query($sql8) || die ('erreur sql8 ! '.$sql8.''.mysql_error());//8
...
. " dev_num int( 30 ) NOT NULL default '0',
 ...
 remise float( 6, 2 ) NOT NULL default '0.00',
 PRIMARY KEY ( num ) )  ";
mysql_query($sql9) || die ('erreur sql9 ! '.$sql9.''.mysql_error());//9
...
. " client_num int( 10 ) NOT NULL default '0',
 ...
 coment VARCHAR( 200 ) NOT NULL default '',
 PRIMARY KEY ( `num_dev` ) )  ";
mysql_query($sql10) || die('Erreur SQL10 !'.$sql10.''.mysql_error());//10
...
. " num_lot int( 10 ) NOT NULL default '0',
 ...
 PRIMARY KEY ( `num` ) )  ";
mysql_query($sql11) || die('Erreur SQL11 !'.$sql11.''.mysql_error());//11
...
. " prod varchar( 25 ) NOT NULL default '',
 ...
 date date NOT NULL default '0000-00-00',
 PRIMARY KEY ( `num` ) )  ";
mysql_query($sql12) || die('Erreur SQL12 !'.$sql12.''.mysql_error());//12
