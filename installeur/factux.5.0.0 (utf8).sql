...
INSERT INTO `factux_user` (`num`, `login`, `nom`, `prenom`, `pwd`, `email`, `dev`, `com`, `fact`, `admin`, `dep`, `stat`, `art`, `cli`) VALUES
(1,	'factux',	'factux',	'factux',	'625ab03d5b953d4b3958d699166603cc',	'factux@free.fr',	'y',	'y',	'y',	'y',	'y',	'y',	'y',	'y');
