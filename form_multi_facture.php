...
<?php } ?>
     ...
     <tr>
      ...
      <td class='<?php echo couleur_alternee (FALSE); ?>'>
       <input type="text" name="date_deb" value="<?php echo sprintf('1/%s/%s', $mois, $annee) ?>" readonly="readonly"/>
     ...
     <tr>
      ...
      <td class='<?php echo couleur_alternee (FALSE); ?>'>
       <input type="text" name="date_fin" value="<?php echo sprintf('%s/%s/%s', $jour, $mois, $annee) ?>" readonly="readonly"/>
