...
<table class="boiteaction">
  <caption><?php echo $lang_choisissez; ?></caption> 
  <tr><td class="texte0"><select name="mois_1">
...
?>
<table class="boiteaction">
  <caption><?php echo "$lang_depenses_tri_par_fournisseur l'année $annee_1"; ?></caption> 
<?php
...
<?php
//stats annuelles
$sql2 = "SELECT SUM(prix)FROM depense WHERE YEAR(date) = $annee_1";
$req = mysql_query($sql2);
while ($data = mysql_fetch_array($req))
			{
			$total_gene = $data['SUM(prix)'];
