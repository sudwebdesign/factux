...
<table width="760" border="0" class="page" align="center">
 <tr>
  ...
  <?php include_once(__DIR__ . "/head.php");?></td>
 </tr>
 <tr>
  <td class="page" align="center">
   <table width="760" border="0" class="page" align="center">
...
<?php
 $sql2 = "SELECT " . $tblpref ."cont_dev.num, uni, quanti, article, tot_art_htva FROM " . $tblpref ."cont_dev RIGHT JOIN " . $tblpref ."article on " . $tblpref ."cont_dev.article_num = " . $tblpref .sprintf('article.num WHERE  dev_num = "%s"', $num_dev);
...
?>
   ...
   <tr>  <td colspan="4" class="page" align="center">
     <form action="refu_devis_suite.php" method="post">
      <table width="760" border="0" class="page" align="center">
       <tr>
        <td class="titretableau" colspan="2"><?php echo sprintf('%s %s %s', $lang_refu, $lang_de_num, $num_dev); ?>?</td>
       </tr>
       <tr>
