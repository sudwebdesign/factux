...
'$pdf->AddPage();' . "\n" .
 ...
 '$pdf->AddCol("tot_art_htva",35,"$lang_tot_arti","C");' . "\n" .
 '$prop=array("HeaderColor"=>array(255,150,100),' . "\n" .
 '"color1"=>array(255,255,210),' . "\n" .
 '"color2"=>array(255,238,204),' . "\n" .
 '"padding"=>2);' . "\n" .
 '$pdf->Table("SELECT " . $tblpref ."cont_bon.num, quanti, uni, article, taux_tva, prix_htva, p_u_jour, tot_art_htva FROM " . $tblpref ."cont_bon LEFT JOIN " . $tblpref ."article on " . $tblpref ."cont_bon.article_num = " . $tblpref ."article.num WHERE  bon_num = $num_bon LIMIT $nb, 15",$prop);' . "\n" .
