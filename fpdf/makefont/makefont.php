...
function MakeDefinitionFile($file, string $type, string $enc, $embed, $map, array $info): void
{
	$s = "<?php\n";
	$s .= '$type = \''.$type."';\n";
...
function MakeFont(string $fontfile, $enc='cp1252', $embed=true): void
{
	...
	$info = $type == 'TrueType' ? GetInfoFromTrueType($fontfile, $embed, $map) : GetInfoFromType1($fontfile, $embed, $map);
