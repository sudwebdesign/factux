...
?>
<form name="form_choisir_client" method="post" action="form_choisir_client.php" >
  <table class="boiteaction">
  <caption><?php echo "Choisir les clients pour cet utilisateur"; ?></caption>
<tr> 
...
?>
		 ...
		 <tr><td class="texte1" colspan="3">Vous pouver choisir plusieurs clients en enfoncant la touche 'Ctrl' de votre clavier</td>
		 </tr>
		 <tr>
